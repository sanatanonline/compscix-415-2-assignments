...
From above, ew see that every tibble has 891 rows (length of the dataset) but the number distinct rows are less than that. That means some rows are repeated.
...
First find out the standard error without resampling (theoritical standard error).
